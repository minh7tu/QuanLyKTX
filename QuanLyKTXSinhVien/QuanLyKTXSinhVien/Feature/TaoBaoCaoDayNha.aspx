<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaoBaoCaoDayNha.aspx.cs" Inherits="QuanLyKTXSinhVien.Feature.TaoBaoCaoDayNha" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tạo báo cáo dãy nhà</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container bg-info ">
            ...
            <nav class="navbar navbar-expand-lg bg-light ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="TaoBaoCaoPhong.aspx">Tạo báo cáo cho phòng sinh viên</a></li>
                                    <li><a class="dropdown-item" href="TaoBaoCaoDayNha.aspx">Tạo báo cáo cho dãy nhà</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="ps-3 pb-4">
                    <asp:Label ID="Label1" runat="server" Text="Nhập vào mã dãy nhà muốn tạo báo cáo"></asp:Label>
                    <asp:TextBox ID="txtBC" runat="server" Width="151px"></asp:TextBox>
                    <asp:Button ID="Button2" runat="server" Text="Xác Nhận" />
                </div>
                <div class="p-3">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="MaDN" DataSourceID="SqlDataSource1" Width="100%">
                 <Columns>
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [DAYNHA] WHERE [MaDN] = @MaDN">
                 <SelectParameters>
                     <asp:ControlParameter ControlID="txtBC" Name="MaDN" PropertyName="Text" Type="String" />
                 </SelectParameters>
             </asp:SqlDataSource>
